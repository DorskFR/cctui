...
//! (CCT-280) that spawns the cctui-worker image via Apple's `container` CLI
//! (Virtualization.framework, one micro-VM per container). Peer of the docker
//! (CCT-246) and kube (CCT-247) dispatchers; the server reaches it over the wire
//! (CCT-248).
//!
//! # Model (CCT-248)
//!
...
//!
//! # Apple `container` specifics (CCT-280)
//!
...
//!
//! # Boot contract (shared with CCT-246/247)
//!
...
//! inspect` / the guest process list is visible (CCT-245). The guest reads it
