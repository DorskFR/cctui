...
//!
//! The server never touches the docker API. On a key-checked `Dispatch` command this
//! executor spawns a worker container on its host and passes the session identity to the
