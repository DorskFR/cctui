...
mod tests {
    ...
    fn apply_prefix_match() {
        let r = Rules::parse("/Users/user=/home/user").unwrap();
        assert_eq!(r.apply_str("/Users/user/x"), "/home/user/x");
    ...
    fn first_match_wins_order() {
        ...
        let r = Rules::parse("/Users/user=/home/user,/Users/user/work=/srv/work").unwrap();
        assert_eq!(r.apply_str("/Users/user/work/a"), "/home/user/work/a");
        // Reversed order: specific rule listed first applies.
        let r = Rules::parse("/Users/user/work=/srv/work,/Users/user=/home/user").unwrap();
        assert_eq!(r.apply_str("/Users/user/work/a"), "/srv/work/a");
    }
    ...
    fn project_dir_roundtrip() {
        let cwd = "/home/user/Documents/foo";
        let enc = encode_project_dir(cwd);
        assert_eq!(enc, "-home-user-Documents-foo");
