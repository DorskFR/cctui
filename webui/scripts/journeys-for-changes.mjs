...
const RULES = [
	...
	{ match: /^webui\/src\/routes\/accounts\//, journeys: () => ['accounts-pools'] },
	...
	{ match: /^webui\/src\/lib\/components\/organisms\/accounts\//, journeys: () => ['accounts-pools'] },
	{ match: /^webui\/src\/lib\/components\/organisms\/AccountCard\.svelte$/, journeys: () => ['accounts-pools'] },
