...
/**
 * One model advertised by `model/list` (codex 0.144.1 `Model`). Only the
 * fields the picker needs are retained; the rest of the codex shape (service
 * tiers, personality, NUX copy) is intentionally dropped.
 */
