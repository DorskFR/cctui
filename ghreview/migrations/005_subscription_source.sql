-- Record how a subscription came to exist so auto-created rows can be
...
-- from a repo's open PRs), 'notification' (auto-subscribed from a
-- participating notification). NULL for rows created before this
